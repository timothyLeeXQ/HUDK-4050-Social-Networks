...
#Record ID is taken over UNI for anonymisation reasons
class_DF <- raw_data %>% select(id = '{"ImportId":"_recordId"}',
                                class1 = '{"ImportId":"QID1_TEXT"}',
                                class2 = '{"ImportId":"QID3_TEXT"}',
                                class3 = '{"ImportId":"QID4_TEXT"}',
                                class4 = '{"ImportId":"QID5_TEXT"}',
                                class5 = '{"ImportId":"QID6_TEXT"}',
                                class6 = '{"ImportId":"QID7_TEXT"}',)
...
person_class_log$course_code <- gsub(pattern = " ", replacement = "", x = person_class_log$course_code)
...
person_class_log$course_code <- gsub(pattern = "QMSS-", replacement = "", x = person_class_log$course_code)
person_class_log$course_code <- gsub(pattern = "QMSS", replacement = "G", x = person_class_log$course_code)
person_class_log$course_code <- gsub(pattern = "GG", replacement = "G", x = person_class_log$course_code)
person_class_log$course_code <- gsub(pattern = "GR", replacement = "G", x = person_class_log$course_code)
...
person_person_graph_data <- graph_from_adjacency_matrix(person_person_matrix)

plot(person_person_graph_data, layout = layout.fruchterman.reingold)
